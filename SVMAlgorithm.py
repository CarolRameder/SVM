...
class SVMAlgorithm:
    ...
    def load_model(self):
        self.__model = mongo.send_file('model.joblib')
        self.__tfidf_vectorizer = mongo.send_file('tfidf_vectorizer.joblib')

    def save_model(self):
        mongo.save_file(self.__model, 'model.joblib')
        mongo.save_file(self.__tfidf_vectorizer, 'tfidf_vectorizer.joblib')
